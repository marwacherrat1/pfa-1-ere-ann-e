...
<section class="banniere" id="banniere">
    <div class="contenu">
        ...
        <p>Bienvenue sur notre site web, relaxer vous, et pensez à rien, avec nous tous sera bien.
        </p>
        <a href="http://localhost/MonProjet/votrechoix.php" class="btn1">votre choix</a>
        <a href="#" class="btn2">recherche</a>
    </div>
</section>
