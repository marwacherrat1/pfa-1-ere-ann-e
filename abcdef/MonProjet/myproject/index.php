...
<section class="banniere" id="banniere">
    <div class="contenu">
        ...
        <a href="#" class="btn1" name="choise">votre choix</a>
        <a href="http://localhost/pfa2/abcdef/myproject/hanae.php" class="btn2" name="submit">recherche</a>
    </div>
</section>
...
<section class="menu" id="menu">
    ...
    <div class="contenu">
        <div class="box">
            <a href="http://localhost/pfa2/abcdef/myproject/films.php" class="imbox">
                <img src="film.jpg">
        ...
        <div class="box">
            <a href="http://localhost/pfa2/abcdef/myproject/serie.php" class="imbox">
                <img src="serie.jpg">
            </a>
            <div class="text">
                <h3>series</h3>
        ...
        <div class="box">
            <a href="http://localhost/pfa2/abcdef/myproject/weebtoon.php" class="imbox">
                <img src="webtoon.png">
            </a>
            <div class="text">
                <h3>weebtoon</h3>
