...
if(isset($_GET['search']))
{
   ...
   $query = "SELECT webtoon.nom, genre.GENRE, webtoon.descrip, webtoon.date_paru,webtoon.episodes FROM webtoon INNER JOIN genre ON webtoon.id_genre=genre.IDGENRE WHERE nom LIKE '%$filtervalues%' ";   
