...
<body>
    ...
    $genre="horror";
    $req="SELECT webtoon.nom, genre.GENRE, webtoon.descrip, webtoon.date_paru, webtoon.episodes FROM webtoon INNER JOIN genre ON webtoon.id_genre=genre.IDGENRE where id_genre=3";    
