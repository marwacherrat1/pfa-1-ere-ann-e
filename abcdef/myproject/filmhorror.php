...
<body>
    ...
    $genre="horror";
    $req="SELECT film.nom, genre.GENRE, film.descrip, film.lien FROM film INNER JOIN genre ON film.id_genre=genre.IDGENRE where id_genre=2";
    ...
    <table>
        ...
        <?php while($ligne= mysqli_fetch_array($result)){
         ...
         <tr>
            ...
            <td> <?php echo "<a href=".$ligne['lien'].">" ?>suivre ce lien</a></td>
            </tr>
         <?php } ?>
    </table>
    <?php } ?>