...
<body>
    ...
    $genre="romance";
    $req="SELECT roman.nom, genre.GENRE, roman.descrip, roman.date_paru, roman.auteur FROM roman INNER JOIN genre ON roman.id_genre=genre.IDGENRE where id_genre=2";
