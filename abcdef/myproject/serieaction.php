...
<body>
    ...
    $genre="romance";
    $req="SELECT serie.nom, genre.GENRE, serie.descrip, serie.date_paru, serie.episodes FROM serie INNER JOIN genre ON serie.id_genre=genre.IDGENRE where id_genre=3";
